      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Logo />
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-stone-800 tracking-tight group-hover:text-amber-800 transition-colors">
                六扇門
              </h1>
          ...
          <div className="flex items-center gap-2">
            <div className="p-2 bg-gradient-to-br from-amber-50 to-red-50 rounded-lg">
              <Wallet size={18} className="text-amber-600" />
            </div>
            <div className="hidden sm:block">
              <p className="text-sm font-bold text-stone-700">員工代墊款</p>
              <p className="text-[10px] text-stone-400 tracking-wider">EXPENSE REIMBURSEMENT</p>
            </div>
          </div>
        </div>
          ...
          <div className="relative hidden md:block" ref={userMenuRef}>
            <button
              ...
              className={`flex items-center gap-2 p-1.5 rounded-xl transition-all border ${
                showUserMenu ? 'bg-amber-50 border-amber-200' : 'border-transparent hover:bg-stone-100 hover:border-stone-200'
              }`}
            >
              <div className="w-9 h-9 bg-gradient-to-br from-amber-600 to-red-600 rounded-lg flex items-center justify-center text-white font-medium text-sm shadow-md shadow-amber-500/20">
              ...
              <ChevronDown
                size={16}
                className={`text-stone-400 transition-transform duration-300 ${showUserMenu ? 'rotate-180 text-amber-500' : ''}`}
              />
            </button>
              ...
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl shadow-stone-200/50 border border-stone-100 py-2 z-50 overflow-hidden ring-1 ring-black/5 animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="p-2 space-y-1">
                  <Link
                    ...
                    className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-stone-600 hover:text-amber-700 hover:bg-amber-50 rounded-xl transition-colors group"
                  >
                    <span className="p-1.5 bg-stone-100 text-stone-500 rounded-lg group-hover:bg-amber-100 group-hover:text-amber-600 transition-colors">
                      <Settings size={16} />
                    </span>
                    帳戶設定
                  </Link>
                ...
                <div className="p-2 border-t border-stone-100">
                  <button
                    ...
                    className="flex items-center gap-3 w-full px-3 py-2.5 text-sm font-medium text-stone-600 hover:text-amber-700 hover:bg-amber-50 rounded-xl transition-colors group"
                  >
                    <span className="p-1.5 bg-stone-100 text-stone-500 rounded-lg group-hover:bg-amber-100 group-hover:text-amber-600 transition-colors">
                      <LogOut size={16} />
                    </span>
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-stone-200 shadow-xl animate-in slide-in-from-top-2 z-50">
          <nav className="flex flex-col p-4 space-y-2">
            ...
            {user && (
              <div className="rounded-xl p-3 mb-4 bg-stone-50 border border-stone-100">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-10 h-10 bg-gradient-to-br from-amber-600 to-red-600 rounded-lg flex items-center justify-center text-white font-medium shadow-sm">
                    {displayName?.charAt(0) || 'U'}
                  </div>
            ...
            <div className="border-t border-stone-100 my-2 pt-2 space-y-1">
              ...
              <button
                onClick={handleLogout}
                className="w-full px-4 py-3 flex items-center gap-3 text-amber-600 hover:bg-amber-50 rounded-xl transition-colors font-medium"
              >
                <LogOut size={20} />
                登出系統
              </button>
