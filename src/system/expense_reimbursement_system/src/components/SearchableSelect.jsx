    ...
    return (
      <div className="relative">
        <input
          ...
          className={`w-full rounded-lg border-stone-300 p-3 border bg-white focus:ring-2 focus:ring-amber-500 outline-none shadow-sm ${className}`}
          autoFocus
        />
        <button
          type="button"
    ...
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className={`
          ...
          ${disabled || loading ? 'bg-stone-100 text-stone-400 cursor-not-allowed' : 'border-stone-300 hover:border-amber-400 cursor-pointer'}
          ...
          <div className="p-2 border-b border-stone-100">
            <div className="relative">
              ...
              <input
                ...
                placeholder="輸入關鍵字搜尋..."
                className="w-full pl-9 pr-3 py-2 border border-stone-200 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
              />
              {searchTerm && (
                <button
                  type="button"
          ...
          <div ref={listRef} className="max-h-60 overflow-y-auto">
                ...
                return (
                  <button
                    ...
                    className={`
                      ...
                      ${isSelected ? 'bg-amber-50 text-amber-700' : 'hover:bg-stone-50 text-stone-700'}
                      transition-colors
                    `}
                  >
                    ...
                    {isSelected && <Check size={16} className="text-amber-600 flex-shrink-0" />}
                  </button>
                );
              })
            )}
            ...
            {allowManualInput && (
              <button
                ...
                className={`w-full px-4 py-2.5 text-left text-sm text-stone-600 border-t border-stone-100 flex items-center gap-2 ${highlightedIndex === filteredOptions.length ? 'bg-amber-100' : 'hover:bg-stone-50'}`}
              >
