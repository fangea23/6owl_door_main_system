      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <p className="text-sm font-bold text-stone-700">教育訓練</p>
              <p className="text-[10px] text-stone-400 tracking-wider">TRAINING SYSTEM</p>
            </div>
          </div>
        </div>
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          {canViewReports && (
            <Link
              ...
              className={getNavLinkClass(isActive('/reports'))}
            >
              <BarChart3 size={18} />
              學習報表
            </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative hidden md:block" ref={userMenuRef}>
            ...
            >
              <div className="w-9 h-9 bg-gradient-to-br from-amber-600 to-orange-600 rounded-lg flex items-center justify-center text-white font-medium text-sm shadow-md shadow-amber-500/20">
            ...
            {user && (
              <div className="rounded-xl p-3 mb-4 bg-stone-50 border border-stone-100">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-10 h-10 bg-gradient-to-br from-amber-600 to-orange-600 rounded-lg flex items-center justify-center text-white font-medium shadow-sm">
                    {displayName?.charAt(0) || 'U'}
                  </div>
