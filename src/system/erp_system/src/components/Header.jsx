      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between relative">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <Logo />
            <div>
              <h1 className="text-lg sm:text-xl font-bold text-stone-800 tracking-tight group-hover:text-orange-800 transition-colors">
                六扇門
              </h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <p className="text-sm font-bold text-stone-700">ERP 管理</p>
              <p className="text-[10px] text-stone-400 tracking-wider">品號/採購管理</p>
            </div>
          </div>
        </div>
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          <Link
            to={`${BASE_PATH}/product-request/new`}
            className={getNavLinkClass(isActive('/product-request/new'))}
          >
            <FilePlus size={18} />
            品號申請
          </Link>
          ...
          <Link
            to={`${BASE_PATH}/suppliers`}
            className={getNavLinkClass(isActive('/suppliers') || isActive('/supplier-request'))}
          >
            <Truck size={18} />
            供應商
          </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative hidden md:block" ref={userMenuRef}>
            ...
            >
              <div className="w-9 h-9 bg-gradient-to-br from-orange-600 to-amber-600 rounded-lg flex items-center justify-center text-white font-medium text-sm shadow-md shadow-orange-500/20">
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl shadow-stone-200/50 border border-stone-100 py-2 z-50 overflow-hidden ring-1 ring-black/5 animate-in fade-in zoom-in-95 duration-200">
                ...
                <div className="px-5 py-4 border-b border-stone-100 bg-stone-50/50">
                  ...
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 text-[10px] font-medium bg-orange-100 text-orange-700 rounded-full border border-orange-200/50">
                ...
                <div className="p-2 border-t border-stone-100">
                  <button
                    ...
                    className="flex items-center gap-3 w-full px-3 py-2.5 text-sm font-medium text-stone-600 hover:text-orange-700 hover:bg-orange-50 rounded-xl transition-colors group"
                  >
                    <span className="p-1.5 bg-stone-100 text-stone-500 rounded-lg group-hover:bg-orange-100 group-hover:text-orange-600 transition-colors">
                      <LogOut size={16} />
                    </span>
        ...
        <div className="md:hidden absolute top-full left-0 w-full bg-white border-b border-stone-200 shadow-xl animate-in slide-in-from-top-2 z-50">
          <nav className="flex flex-col p-4 space-y-2">
            ...
            {user && (
              <div className="rounded-xl p-3 mb-4 bg-stone-50 border border-stone-100">
                <div className="flex items-center gap-3 mb-2">
                  <div className="w-10 h-10 bg-gradient-to-br from-orange-600 to-amber-600 rounded-lg flex items-center justify-center text-white font-medium shadow-sm">
                    {displayName?.charAt(0) || 'U'}
                  </div>
            ...
            <Link
              ...
              onClick={closeMenu}
              className={`px-4 py-3 rounded-xl text-base font-medium flex items-center gap-3 transition-colors ${
                isActive('/suppliers') || isActive('/supplier-request')
                  ? 'bg-orange-50 text-orange-700'
                  : 'text-stone-600 hover:bg-stone-50'
              }`}
            >
            ...
            <div className="border-t border-stone-100 my-2 pt-2 space-y-1">
              ...
              <button
                onClick={handleLogout}
                className="w-full px-4 py-3 flex items-center gap-3 text-orange-600 hover:bg-orange-50 rounded-xl transition-colors font-medium"
              >
                <LogOut size={20} />
                登出系統
              </button>
