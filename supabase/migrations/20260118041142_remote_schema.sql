...
alter table "payment_approval"."branches" enable row level security;
  ...
  create table "payment_approval"."brands" (
    "id" bigint generated by default as identity not null,
    "name" text not null,
    "code" text
      );
...
alter table "payment_approval"."payment_requests" enable row level security;
  ...
  create table "payment_approval"."stores" (
    "id" bigint generated by default as identity not null,
...
CREATE UNIQUE INDEX brands_name_key ON payment_approval.brands USING btree (name);

CREATE UNIQUE INDEX brands_pkey ON payment_approval.brands USING btree (id);
...
CREATE UNIQUE INDEX stores_pkey ON payment_approval.stores USING btree (id);
...
alter table "payment_approval"."brands" add constraint "brands_pkey" PRIMARY KEY using index "brands_pkey";
...
alter table "payment_approval"."stores" add constraint "stores_pkey" PRIMARY KEY using index "stores_pkey";
...
alter table "car_rental"."rental_requests" add constraint "rental_requests_requester_id_fkey" FOREIGN KEY (requester_id) REFERENCES auth.users(id) not valid;

alter table "car_rental"."rental_requests" validate constraint "rental_requests_requester_id_fkey";

alter table "car_rental"."rental_requests" add constraint "rental_requests_reviewer_id_fkey" FOREIGN KEY (reviewer_id) REFERENCES auth.users(id) not valid;
...
alter table "car_rental"."rentals" add constraint "rentals_renter_id_fkey" FOREIGN KEY (renter_id) REFERENCES auth.users(id) not valid;
...
alter table "payment_approval"."brands" add constraint "brands_name_key" UNIQUE using index "brands_name_key";
...
alter table "payment_approval"."stores" add constraint "stores_brand_id_fkey" FOREIGN KEY (brand_id) REFERENCES payment_approval.brands(id) not valid;

alter table "payment_approval"."stores" validate constraint "stores_brand_id_fkey";
...
alter table "public"."employees" add constraint "fk_employees_departments" FOREIGN KEY (department_id) REFERENCES public.departments(id) not valid;

alter table "public"."employees" validate constraint "fk_employees_departments";
...
alter table "service"."tickets" add constraint "tickets_reporter_store_id_fkey" FOREIGN KEY (reporter_store_id) REFERENCES public.stores(id) not valid;

alter table "service"."tickets" validate constraint "tickets_reporter_store_id_fkey";
...
alter table "software_maintenance"."license_assignments" add constraint "license_assignments_device_id_fkey" FOREIGN KEY (device_id) REFERENCES software_maintenance.devices(id) not valid;

alter table "software_maintenance"."license_assignments" validate constraint "license_assignments_device_id_fkey";
...
CREATE OR REPLACE FUNCTION public.deactivate_license(p_license_key text, p_machine_id text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
CREATE OR REPLACE FUNCTION public.verify_license(p_license_key text, p_machine_id text, p_machine_name text DEFAULT NULL::text, p_ip_address text DEFAULT NULL::text)
 RETURNS json
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$
...
grant delete on table "payment_approval"."brands" to "anon";

grant insert on table "payment_approval"."brands" to "anon";

grant references on table "payment_approval"."brands" to "anon";

grant select on table "payment_approval"."brands" to "anon";

grant trigger on table "payment_approval"."brands" to "anon";

grant truncate on table "payment_approval"."brands" to "anon";

grant update on table "payment_approval"."brands" to "anon";

grant delete on table "payment_approval"."brands" to "authenticated";

grant insert on table "payment_approval"."brands" to "authenticated";

grant references on table "payment_approval"."brands" to "authenticated";

grant select on table "payment_approval"."brands" to "authenticated";

grant trigger on table "payment_approval"."brands" to "authenticated";

grant truncate on table "payment_approval"."brands" to "authenticated";

grant update on table "payment_approval"."brands" to "authenticated";

grant delete on table "payment_approval"."brands" to "service_role";

grant insert on table "payment_approval"."brands" to "service_role";

grant references on table "payment_approval"."brands" to "service_role";

grant select on table "payment_approval"."brands" to "service_role";

grant trigger on table "payment_approval"."brands" to "service_role";

grant truncate on table "payment_approval"."brands" to "service_role";

grant update on table "payment_approval"."brands" to "service_role";
...
grant delete on table "payment_approval"."stores" to "anon";

grant insert on table "payment_approval"."stores" to "anon";

grant references on table "payment_approval"."stores" to "anon";

grant select on table "payment_approval"."stores" to "anon";

grant trigger on table "payment_approval"."stores" to "anon";

grant truncate on table "payment_approval"."stores" to "anon";

grant update on table "payment_approval"."stores" to "anon";

grant delete on table "payment_approval"."stores" to "authenticated";

grant insert on table "payment_approval"."stores" to "authenticated";

grant references on table "payment_approval"."stores" to "authenticated";

grant select on table "payment_approval"."stores" to "authenticated";

grant trigger on table "payment_approval"."stores" to "authenticated";

grant truncate on table "payment_approval"."stores" to "authenticated";

grant update on table "payment_approval"."stores" to "authenticated";

grant delete on table "payment_approval"."stores" to "service_role";

grant insert on table "payment_approval"."stores" to "service_role";

grant references on table "payment_approval"."stores" to "service_role";

grant select on table "payment_approval"."stores" to "service_role";

grant trigger on table "payment_approval"."stores" to "service_role";

grant truncate on table "payment_approval"."stores" to "service_role";

grant update on table "payment_approval"."stores" to "service_role";
